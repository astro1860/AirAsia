...
*Data Analyze*
  ...
  * store data in csv for data visualization
*Data visualization*
  ...
  * Using leaflet.js and mapbox to create map visualzing location of 12 cites
  * using bootstrap and jquery to create layouts of website
